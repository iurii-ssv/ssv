...
import (
	...
	slotoracle "github.com/ssvlabs/ssv/operator/slotoracle"
...
func (m *MockdutyHandler) Setup(name string, logger *zap.Logger, beaconNode BeaconNode, executionClient ExecutionClient, network networkconfig.NetworkConfig, validatorProvider ValidatorProvider, validatorController ValidatorController, dutiesExecutor DutiesExecutor, slotOracleProvider slotoracle.Provider, reorgEvents chan ReorgEvent, indicesChange chan struct{}) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Setup", name, logger, beaconNode, executionClient, network, validatorProvider, validatorController, dutiesExecutor, slotOracleProvider, reorgEvents, indicesChange)
}

// Setup indicates an expected call of Setup.
func (mr *MockdutyHandlerMockRecorder) Setup(name, logger, beaconNode, executionClient, network, validatorProvider, validatorController, dutiesExecutor, slotOracleProvider, reorgEvents, indicesChange any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Setup", reflect.TypeOf((*MockdutyHandler)(nil).Setup), name, logger, beaconNode, executionClient, network, validatorProvider, validatorController, dutiesExecutor, slotOracleProvider, reorgEvents, indicesChange)
}
